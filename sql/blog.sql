...
CREATE TABLE `t_blog_article`  (
  ...
  `type` tinyint(4) NOT NULL DEFAULT 1 COMMENT '类型 1 技术文章 2 普通文章 3 其他',
  ...
  `isdel` tinyint(4) NOT NULL DEFAULT 1 COMMENT '是否删除 0 删除 1 正常',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章表' ROW_FORMAT = Compact;
